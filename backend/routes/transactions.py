...
from models.schemas import WeeklyData, TransactionUpdate
from services.data_service import get_weekly_data, save_weekly_transactions, get_week_start, get_week_label, load_transactions
import io
        ...
        data = [
            {
                "category": t.category,
                "type": t.type,
                "budget": 0,  # Will be calculated from actual API data
                "actual": t.actual
            }
